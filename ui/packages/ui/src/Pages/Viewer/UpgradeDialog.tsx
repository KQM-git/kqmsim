...
const DialogBody = ({ mismatch, data, latestCommit }: BodyProps) => {
  ...
  const resultCommitUrl = "https://github.com/KQM-git/kqmsim/commits/" + simCommit;
  const latestCommitUrl = "https://github.com/KQM-git/kqmsim/commits/" + latestCommit;
  const diffUrl = (
    "https://github.com/KQM-git/kqmsim/compare/" + simCommit + "..." + latestCommit
  );
